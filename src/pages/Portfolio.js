      ...
      <div className='row mt-2 justify-content-around'>
        ...
        <div className='card p-0 col-12 col-xxl-4 mb-5' style={{width: "30rem", backgroundColor: '#511981', boxShadow: '15px 10px 10px black'}}>
          ...
          <div className='card-body'>
            ...
            <h6 className='card-subtitle mb-2'>Collaborative</h6>
        ...
        <div className='card p-0 col-12 col-xxl-4 mb-5' style={{width: "30rem", height: '37rem', backgroundColor: '#511981', boxShadow: '15px 10px 10px black'}}>
          <div className='card-body'>
            <h4 className='card-title'>Employee Tracker</h4>
            <h6 className='card-subtitle mb-2'>Solo</h6>
